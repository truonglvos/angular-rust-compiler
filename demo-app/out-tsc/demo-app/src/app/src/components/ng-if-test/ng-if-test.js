...
export class NgIfTest {
	...
	static ɵcmp = /* @__PURE__ */ i0.ɵɵdefineComponent({
		...
		template: function NgIfTest_Template(rf, ctx) {
			...
			if (rf & 2) {
				i0.ɵɵadvance(16);
				const loggedOutTemplate_r10 = i0.ɵɵreference(16);
				i0.ɵɵadvance(8);
				const loadingTpl_r11 = i0.ɵɵreference(24);
				i0.ɵɵadvance(2);
				const contentTpl_r12 = i0.ɵɵreference(26);
				i0.ɵɵadvance(34);
				const noItemsTpl_r13 = i0.ɵɵreference(60);
				...
				i0.ɵɵadvance(8);
				i0.ɵɵproperty("ngIf", ctx.isLoading)("ngIfThen", loadingTpl_r11)("ngIfElse", contentTpl_r12);
				i0.ɵɵadvance(9);

...
export class PropertyBindingTest {
    ...
    static ɵfac = function PropertyBindingTest_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || PropertyBindingTest)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PropertyBindingTest, selectors: [["app-property-binding-test"]], decls: 83, vars: 42, consts: [[1, "property-binding-test"], ["width", "100", 3, "src", "alt"], ["target", "_blank", 3, "href"], [3, "click"], ["type", "text", "placeholder", "Disabled test", "value", "Test", 3, "disabled"], ["type", "text", "placeholder", "Readonly test", "value", "Readonly", 3, "readonly"], [3, "hidden"], [1, "styled-box"], [3, "ngStyle"], [1, "box"], [1, "box", 3, "ngClass"]], template: function PropertyBindingTest_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵlistener("click", function PropertyBindingTest_Template_button_click_15_listener() { return ctx.toggleDisabled(); });
            i0.ɵɵtext(16, "Toggle Disabled");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(17, "button", 3);
            i0.ɵɵlistener("click", function PropertyBindingTest_Template_button_click_17_listener() { return ctx.toggleReadonly(); });
            i0.ɵɵtext(18, "Toggle Readonly");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(19, "button", 3);
            i0.ɵɵlistener("click", function PropertyBindingTest_Template_button_click_19_listener() { return ctx.toggleHidden(); });
            ...
            i0.ɵɵlistener("click", function PropertyBindingTest_Template_button_click_31_listener() { return ctx.setColor("red"); });
            i0.ɵɵtext(32, "Red");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(33, "button", 3);
            i0.ɵɵlistener("click", function PropertyBindingTest_Template_button_click_33_listener() { return ctx.setColor("green"); });
            i0.ɵɵtext(34, "Green");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(35, "button", 3);
            i0.ɵɵlistener("click", function PropertyBindingTest_Template_button_click_35_listener() { return ctx.setColor("blue"); });
            i0.ɵɵtext(36, "Blue");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(37, "button", 3);
            i0.ɵɵlistener("click", function PropertyBindingTest_Template_button_click_37_listener() { return ctx.increaseFontSize(); });
            i0.ɵɵtext(38, "Font +");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(39, "button", 3);
            i0.ɵɵlistener("click", function PropertyBindingTest_Template_button_click_39_listener() { return ctx.decreaseFontSize(); });
            i0.ɵɵtext(40, "Font -");
            i0.ɵɵelementEnd()();
            ...
            i0.ɵɵlistener("click", function PropertyBindingTest_Template_button_click_54_listener() { return ctx.toggleActive(); });
            i0.ɵɵtext(55, "Toggle Active");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(56, "button", 3);
            i0.ɵɵlistener("click", function PropertyBindingTest_Template_button_click_56_listener() { return ctx.toggleHighlighted(); });
            i0.ɵɵtext(57, "Toggle Highlighted");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(58, "button", 3);
            i0.ɵɵlistener("click", function PropertyBindingTest_Template_button_click_58_listener() { return ctx.togglePrimary(); });
            ...
            i0.ɵɵlistener("click", function PropertyBindingTest_Template_button_click_72_listener() { return ctx.toggleAriaExpanded(); });
            ...
            i0.ɵɵadvance(3);
            i0.ɵɵtextInterpolate3("Disabled: ", ctx.isDisabled, ", Readonly: ", ctx.isReadonly, ", Hidden: ", ctx.isHidden);
            i0.ɵɵadvance(15);
            i0.ɵɵstyleProp("color", ctx.textColor)("font-size", ctx.fontSize, "px");
            i0.ɵɵadvance(2);
            i0.ɵɵstyleProp("width", ctx.boxWidth, "px")("height", ctx.boxHeight, "px")("background-color", ctx.backgroundColor)("border-radius", ctx.borderRadius, "px");
            i0.ɵɵadvance(5);
            i0.ɵɵproperty("ngStyle", ctx.dynamicStyles);
            i0.ɵɵadvance(12);
            i0.ɵɵclassProp("active", ctx.isActive)("highlighted", ctx.isHighlighted)("primary", ctx.isPrimary);
            i0.ɵɵadvance(3);
            i0.ɵɵtextInterpolate3("Active: ", ctx.isActive, ", Highlighted: ", ctx.isHighlighted, ", Primary: ", ctx.isPrimary);
            i0.ɵɵadvance(4);
            i0.ɵɵproperty("ngClass", ctx.dynamicClasses);
            i0.ɵɵadvance(5);
            i0.ɵɵattribute("aria-label", ctx.ariaLabel)("aria-expanded", ctx.ariaExpanded)("aria-disabled", ctx.ariaDisabled)("data-id", ctx.dataId)("data-type", ctx.dataType);
            i0.ɵɵadvance(3);

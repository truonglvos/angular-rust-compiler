...
export class EventBindingTest {
  ...
  static ɵfac = function EventBindingTest_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || EventBindingTest)();
  };
  static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({
    ...
    template: function EventBindingTest_Template(rf, ctx) {
      if (rf & 1) {
        ...
        )('mouseleave', function EventBindingTest_Template_div_mouseleave_20_listener() {
          i0.ɵɵrestoreView(_r1);
          return i0.ɵɵresetView(ctx.onMouseLeave());
        })('mousemove', function EventBindingTest_Template_div_mousemove_20_listener($event) {
          i0.ɵɵrestoreView(_r1);
          return i0.ɵɵresetView(ctx.onMouseMove($event));
        })('mousedown', function EventBindingTest_Template_div_mousedown_20_listener($event) {
          i0.ɵɵrestoreView(_r1);
          return i0.ɵɵresetView(ctx.onMouseDown($event));
        })('mouseup', function EventBindingTest_Template_div_mouseup_20_listener($event) {
          i0.ɵɵrestoreView(_r1);
        ...
        })('keydown', function EventBindingTest_Template_input_keydown_30_listener($event) {
          i0.ɵɵrestoreView(_r1);
          return i0.ɵɵresetView(ctx.onKeyDown($event));
        })('keyup', function EventBindingTest_Template_input_keyup_30_listener($event) {
          i0.ɵɵrestoreView(_r1);
          return i0.ɵɵresetView(ctx.onKeyUp($event));
        })('keydown.enter', function EventBindingTest_Template_input_keydown_enter_30_listener() {
          i0.ɵɵrestoreView(_r1);
          return i0.ɵɵresetView(ctx.onEnterKey());
        })('keydown.escape', function EventBindingTest_Template_input_keydown_escape_30_listener() {
          i0.ɵɵrestoreView(_r1);
        ...
        })('blur', function EventBindingTest_Template_input_blur_43_listener() {
          i0.ɵɵrestoreView(_r1);
        ...
        i0.ɵɵtwoWayListener(
          'ngModelChange',
          function EventBindingTest_Template_input_ngModelChange_50_listener($event) {
            i0.ɵɵrestoreView(_r1);
...
(() => {
  (typeof ngDevMode === 'undefined' || ngDevMode) &&
    i0.ɵsetClassDebugInfo(EventBindingTest, {
      className: 'EventBindingTest',
      filePath: 'src/app/src/components/event-binding-test/event-binding-test.ts',
      lineNumber: 18,
    });
})();

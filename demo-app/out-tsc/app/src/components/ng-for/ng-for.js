...
function NgForTest_li_7_Template(rf, ctx) { if (rf & 1) {
...
function NgForTest_div_11_span_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span");
    i0.ɵɵtext(1, "(First)");
    i0.ɵɵelementEnd();
} }
function NgForTest_div_11_span_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span");
    i0.ɵɵtext(1, "(Last)");
    i0.ɵɵelementEnd();
} }
function NgForTest_div_11_span_4_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span");
    i0.ɵɵtext(1, "[Even]");
    i0.ɵɵelementEnd();
} }
function NgForTest_div_11_span_5_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span");
    i0.ɵɵtext(1, "[Odd]");
    i0.ɵɵelementEnd();
} }
function NgForTest_div_11_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 6);
    i0.ɵɵtext(1);
    i0.ɵɵtemplate(2, NgForTest_div_11_span_2_Template, 2, 0, "span", 7)(3, NgForTest_div_11_span_3_Template, 2, 0, "span", 7)(4, NgForTest_div_11_span_4_Template, 2, 0, "span", 7)(5, NgForTest_div_11_span_5_Template, 2, 0, "span", 7);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function NgForTest_tr_31_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function NgForTest_tr_31_Template_button_click_11_listener() { const user_r9 = i0.ɵɵrestoreView(_r8).$implicit; const ctx_r9 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r9.toggleActive(user_r9)); });
    i0.ɵɵtext(12, "Toggle");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(13, "button", 3);
    i0.ɵɵlistener("click", function NgForTest_tr_31_Template_button_click_13_listener() { const user_r9 = i0.ɵɵrestoreView(_r8).$implicit; const ctx_r9 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r9.removeUser(user_r9.id)); });
    i0.ɵɵtext(14, "Remove");
    i0.ɵɵelementEnd()()();
} if (rf & 2) {
...
function NgForTest_div_35_li_4_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "li");
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function NgForTest_div_35_Template(rf, ctx) { if (rf & 1) {
...
function NgForTest_div_39_Template(rf, ctx) { if (rf & 1) {
...
export class NgForTest {
    ...
    static ɵfac = function NgForTest_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || NgForTest)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: NgForTest, selectors: [["app-ng-for"]], decls: 43, vars: 7, consts: [[1, "ng-for-test"], [4, "ngFor", "ngForOf"], ["class", "number-item", 3, "first", "last", "even", "odd", 4, "ngFor", "ngForOf"], [3, "click"], [3, "active", "inactive", 4, "ngFor", "ngForOf", "ngForTrackBy"], ["class", "category", 4, "ngFor", "ngForOf"], [1, "number-item"], [4, "ngIf"], [1, "category"]], template: function NgForTest_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵlistener("click", function NgForTest_Template_button_click_15_listener() { return ctx.addUser(); });

...
const _c0 = () => ['/home'];
const _c1 = () => ({ ref: 'component8' });
const _forTrack0 = ($index, $item) => $item.id;
function Benchmark8Component_For_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, 'li', 13);
    i0.ɵɵlistener('click', function Benchmark8Component_For_10_Template_li_click_0_listener() {
...
function Benchmark8Component_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function Benchmark8Component_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    i0.ɵɵlistener(
      'click',
      function Benchmark8Component_Conditional_13_Template_button_click_3_listener() {
...
function Benchmark8Component_Conditional_14_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, 'article', 18);
    i0.ɵɵlistener(
      'mouseenter',
      function Benchmark8Component_Conditional_14_For_2_Template_article_mouseenter_0_listener() {
      ...
      'mouseleave',
      function Benchmark8Component_Conditional_14_For_2_Template_article_mouseleave_0_listener() {
        const row_r6 = i0.ɵɵrestoreView(_r5).$implicit;
        const ctx_r2 = i0.ɵɵnextContext(2);
    ...
    i0.ɵɵlistener(
      'click',
      function Benchmark8Component_Conditional_14_For_2_Template_button_click_12_listener() {
        const row_r6 = i0.ɵɵrestoreView(_r5).$implicit;
        const ctx_r2 = i0.ɵɵnextContext(2);
    ...
    i0.ɵɵlistener(
      'click',
      function Benchmark8Component_Conditional_14_For_2_Template_button_click_14_listener() {
        const row_r6 = i0.ɵɵrestoreView(_r5).$implicit;
        const ctx_r2 = i0.ɵɵnextContext(2);
...
function Benchmark8Component_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    i0.ɵɵelementStart(0, 'section', 8);
    i0.ɵɵrepeaterCreate(
      1,
      Benchmark8Component_Conditional_14_For_2_Template,
      16,
      18,
      'article',
      17,
...
function Benchmark8Component_div_16_Template(rf, ctx) {
  if (rf & 1) {
...
export class Benchmark8Component {
  title = 'Benchmark Component 8';
  ...
  edit(row) {}
  delete(row) {}
  static ɵfac = function Benchmark8Component_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || Benchmark8Component)();
  };
  static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({
    type: Benchmark8Component,
    selectors: [['app-benchmark-8']],
    inputs: { title: 'title', subtitle: 'subtitle' },
    outputs: { action: 'action' },
    decls: 22,
    vars: 15,
    consts: [
      [1, 'benchmark-component-8'],
      [1, 'header', 3, 'click'],
      [1, 'subtitle'],
      [1, 'navigation'],
      [3, 'selected'],
    ...
    template: function Benchmark8Component_Template(rf, ctx) {
      if (rf & 1) {
        i0.ɵɵelementStart(0, 'div', 0)(1, 'header', 1);
        i0.ɵɵlistener(
          'click',
          function Benchmark8Component_Template_header_click_1_listener($event) {
        ...
        i0.ɵɵrepeaterCreate(9, Benchmark8Component_For_10_Template, 3, 5, 'li', 4, _forTrack0);
        i0.ɵɵelementEnd()();
        i0.ɵɵelementStart(11, 'main', 5);
        i0.ɵɵconditionalCreate(12, Benchmark8Component_Conditional_12_Template, 3, 2, 'div', 6)(
          13,
          Benchmark8Component_Conditional_13_Template,
          5,
          3,
          'div',
          7,
        )(14, Benchmark8Component_Conditional_14_Template, 3, 0, 'section', 8);
        i0.ɵɵelementEnd();
        i0.ɵɵelementStart(15, 'aside', 9);
        i0.ɵɵtemplate(16, Benchmark8Component_div_16_Template, 4, 2, 'div', 10);
        i0.ɵɵelementEnd();
      ...
      if (rf & 2) {
        ...
        i0.ɵɵadvance(2);
        i0.ɵɵtextInterpolate1('\u00A9 ', ctx.currentYear, ' - Component 8');
        i0.ɵɵadvance();
...
(() => {
  (typeof ngDevMode === 'undefined' || ngDevMode) &&
    i0.ɵsetClassDebugInfo(Benchmark8Component, {
      className: 'Benchmark8Component',
      filePath: 'src/app/benchmark/benchmark-8.component.ts',
      lineNumber: 11,
    });
})();

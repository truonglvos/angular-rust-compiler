...
export class Benchmark69Component {
  ...
  edit(row) {}
  delete(row) {}
  static ɵfac = function Benchmark69Component_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || Benchmark69Component)();
  };
...
(() => {
  (typeof ngDevMode === 'undefined' || ngDevMode) &&
    i0.ɵsetClassDebugInfo(Benchmark69Component, {
      className: 'Benchmark69Component',
      filePath: 'src/app/benchmark/benchmark-69.component.ts',
      lineNumber: 11,
    });
})();

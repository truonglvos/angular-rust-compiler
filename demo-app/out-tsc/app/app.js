...
export class App {
  ...
  surname = 'Lê';
  name = 'Trường';
  title = signal('demo-app 5', ...(ngDevMode ? [{ debugName: 'title' }] : []));
  items = signal(
    [
...
(() => {
  (typeof ngDevMode === 'undefined' || ngDevMode) &&
    i0.ɵsetClassDebugInfo(App, { className: 'App', filePath: 'src/app/app.ts', lineNumber: 44 });
})();

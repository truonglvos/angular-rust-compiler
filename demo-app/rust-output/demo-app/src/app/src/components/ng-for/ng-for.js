...
function NgForTest_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    i0.ɵɵtemplate(3, NgForTest_div_11_span_3_Template, 2, 0, 'span', 7);
    i0.ɵɵtemplate(4, NgForTest_div_11_span_4_Template, 2, 0, 'span', 7);
    i0.ɵɵtemplate(5, NgForTest_div_11_span_5_Template, 2, 0, 'span', 7);
    i0.ɵɵelementEnd();
  }
  if (rf & 2) {
    ...
    i0.ɵɵclassProp('first', isFirst_r4);
    i0.ɵɵclassProp('last', isLast_r5);
    i0.ɵɵclassProp('even', isEven_r6);
    i0.ɵɵclassProp('odd', isOdd_r7);
    i0.ɵɵadvance();
...
function NgForTest_tr_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    i0.ɵɵlistener('click', function NgForTest_tr_31_Template_button_click_11_listener() {
      const ctx = i0.ɵɵrestoreView(_r8);
  ...
  if (rf & 2) {
    const user_r9 = ctx.$implicit;
    i0.ɵɵclassProp('active', user_r9.active);
    i0.ɵɵclassProp('inactive', !user_r9.active);
    i0.ɵɵadvance(2);
    ...
    i0.ɵɵtextInterpolate1(
      '\n              ',
      user_r9.active ? 'Active' : 'Inactive',
      '\n            '
    );
  }
}
...
function NgForTest_div_39_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate2('\n      ', item_r14, ' (Total items: ', total_r15, ')\n    ');
  }
}
  ...
  static ɵcmp = /* @__PURE__ */ i0.ɵɵdefineComponent({
    ...
    template: function NgForTest_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        i0.ɵɵproperty('ngForTrackBy', ctx.trackByUserId);
        i0.ɵɵadvance(4);

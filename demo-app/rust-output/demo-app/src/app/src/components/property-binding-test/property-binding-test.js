	...
	static ɵcmp = /* @__PURE__ */ i0.ɵɵdefineComponent({
		...
		template: function PropertyBindingTest_Template(rf, ctx) {
			...
			if (rf & 2) {
				...
				i0.ɵɵproperty("alt", ctx.imageAlt);
				i0.ɵɵadvance();
				...
				i0.ɵɵadvance(2);
				i0.ɵɵstyleProp("width", ctx.boxWidth, "px");
				i0.ɵɵstyleProp("height", ctx.boxHeight, "px");
				i0.ɵɵstyleProp("background-color", ctx.backgroundColor);
				i0.ɵɵstyleProp("border-radius", ctx.borderRadius, "px");
				i0.ɵɵadvance(5);
				i0.ɵɵproperty("ngStyle", ctx.dynamicStyles);
				i0.ɵɵadvance(12);
				i0.ɵɵclassProp("active", ctx.isActive);
				i0.ɵɵclassProp("highlighted", ctx.isHighlighted);
				i0.ɵɵclassProp("primary", ctx.isPrimary);
				i0.ɵɵadvance(3);

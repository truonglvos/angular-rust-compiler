...
use crate::template::pipeline::ir::ops::update::{create_i18n_apply_op, I18nExpressionOp};
...
fn process_unit(
    ...
    let mut indices_to_insert_after: Vec<(usize, ir::XrefId, SlotHandle, ParseSourceSpan)> =
        Vec::new();

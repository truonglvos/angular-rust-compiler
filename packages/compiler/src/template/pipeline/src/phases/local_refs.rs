...
use crate::output::output_ast::{Expression, LiteralExpr, LiteralValue, LiteralArrayExpr};
            ...
            | OpKind::Template => {
                unsafe {
                    use crate::template::pipeline::ir::ops::create::{
                        ElementStartOp, ConditionalCreateOp, ConditionalBranchCreateOp, TemplateOp,
                    };
                    ...
                    match op.kind() {
                        OpKind::ElementStart => {
                            ...
                            if local_refs_len > 0 {
                                ...
                                let const_index = (&mut *component_job_ptr).add_const(local_refs_expr, None);

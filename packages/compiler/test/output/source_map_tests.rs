...
use angular_compiler::output::source_map::{SourceMapGenerator, to_base64_string};
...
mod tests {
    ...
    fn should_generate_a_valid_source_map() {
        let mut map = SourceMapGenerator::new(Some("out.js".to_string()));
         map.add_source("a.js".to_string(), None)
            .add_line()
            .add_mapping(0, Some("a.js".to_string()), Some(0), Some(0)).unwrap()
            .add_mapping(4, Some("a.js".to_string()), Some(0), Some(6)).unwrap()
            .add_mapping(5, Some("a.js".to_string()), Some(0), Some(7)).unwrap()
            .add_mapping(8, Some("a.js".to_string()), Some(0), Some(22)).unwrap()
            .add_mapping(9, Some("a.js".to_string()), Some(0), Some(23)).unwrap()
            .add_mapping(10, Some("a.js".to_string()), Some(0), Some(24)).unwrap()
            .add_line()
            .add_mapping(0, Some("a.js".to_string()), Some(1), Some(0)).unwrap()
            .add_mapping(4, Some("a.js".to_string()), Some(1), Some(6)).unwrap()
            .add_mapping(5, Some("a.js".to_string()), Some(1), Some(7)).unwrap()
            .add_mapping(8, Some("a.js".to_string()), Some(1), Some(10)).unwrap()
            .add_mapping(9, Some("a.js".to_string()), Some(1), Some(11)).unwrap()
            .add_mapping(10, Some("a.js".to_string()), Some(1), Some(12)).unwrap()
            .add_line()
            .add_mapping(0, Some("a.js".to_string()), Some(3), Some(0)).unwrap()
            .add_mapping(2, Some("a.js".to_string()), Some(3), Some(2)).unwrap()
            .add_mapping(3, Some("a.js".to_string()), Some(3), Some(3)).unwrap()
            .add_mapping(10, Some("a.js".to_string()), Some(3), Some(10)).unwrap()
            .add_mapping(11, Some("a.js".to_string()), Some(3), Some(11)).unwrap()
            .add_mapping(21, Some("a.js".to_string()), Some(3), Some(11)).unwrap()
            .add_mapping(22, Some("a.js".to_string()), Some(3), Some(12)).unwrap()
            .add_line()
            .add_mapping(4, Some("a.js".to_string()), Some(4), Some(4)).unwrap()
            .add_mapping(11, Some("a.js".to_string()), Some(4), Some(11)).unwrap()
            .add_mapping(12, Some("a.js".to_string()), Some(4), Some(12)).unwrap()
            .add_mapping(15, Some("a.js".to_string()), Some(4), Some(15)).unwrap()
            .add_mapping(16, Some("a.js".to_string()), Some(4), Some(16)).unwrap()
            .add_mapping(21, Some("a.js".to_string()), Some(4), Some(21)).unwrap()
            .add_mapping(22, Some("a.js".to_string()), Some(4), Some(22)).unwrap()
            .add_mapping(23, Some("a.js".to_string()), Some(4), Some(23)).unwrap()
            .add_line()
            .add_mapping(0, Some("a.js".to_string()), Some(5), Some(0)).unwrap()
            .add_mapping(1, Some("a.js".to_string()), Some(5), Some(1)).unwrap()
            .add_mapping(2, Some("a.js".to_string()), Some(5), Some(2)).unwrap()
            .add_mapping(3, Some("a.js".to_string()), Some(5), Some(2)).unwrap();
    ...
    fn should_include_the_files_and_their_contents() {
        ...
        map.add_source("inline.ts".to_string(), Some("inline".to_string()))
           ...
           .add_line()
           .add_mapping(0, Some("inline.ts".to_string()), Some(0), Some(0)).unwrap();
    ...
    fn should_not_generate_source_maps_when_there_is_no_mapping() {
        ...
        smg.add_source("inline.ts".to_string(), Some("inline".to_string())).add_line();
    ...
    fn should_error_when_mappings_are_added_out_of_order() {
        ...
        gen.add_mapping(10, Some("in.js".to_string()), Some(0), Some(0)).unwrap();
    ...
    fn should_error_when_adding_segments_before_any_line_is_created() {
        let mut gen = SourceMapGenerator::new(Some("out.js".to_string()));
        let res = gen.add_source("in.js".to_string(), None).add_mapping(0, Some("in.js".to_string()), Some(0), Some(0));
        match res {
    ...
    fn should_error_when_adding_segments_referencing_unknown_sources() {
        let mut gen = SourceMapGenerator::new(Some("out.js".to_string()));
        let res = gen.add_source("in.js".to_string(), None).add_line().add_mapping(0, Some("in_.js".to_string()), Some(0), Some(0));
        match res {
    ...
    fn should_error_when_adding_segments_with_a_source_url_but_no_position() {
        let mut gen = SourceMapGenerator::new(Some("out.js".to_string()));
        let res = gen.add_source("in.js".to_string(), None).add_line().add_mapping(0, Some("in.js".to_string()), None, None);
        match res {
            Err(ref msg) => assert_eq!(msg, "The source location must be provided when a source url is provided"),
            Ok(_) => panic!("Expected error but got Ok"),
        }
        
        let mut gen2 = SourceMapGenerator::new(Some("out.js".to_string()));
        let res2 = gen2.add_source("in.js".to_string(), None).add_line().add_mapping(0, Some("in.js".to_string()), Some(0), None);
        match res2 {
            Err(ref msg) => assert_eq!(msg, "The source location must be provided when a source url is provided"),
            Ok(_) => panic!("Expected error but got Ok"),
        }

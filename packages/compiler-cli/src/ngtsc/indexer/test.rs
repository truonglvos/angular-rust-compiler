...
mod tests {
    ...
    mod indexing_context_tests {
        ...
        fn should_add_component() {
            ...
            ctx.add_component("app.component.ts", IndexedComponent {
        ...
        fn should_iterate_all_components() {
            ...
            ctx.add_component("a.ts", IndexedComponent {
                name: "A".to_string(),
            ...
            ctx.add_component("b.ts", IndexedComponent {
                name: "B".to_string(),
    ...
    mod indexer_tests {
        ...
        fn should_get_mutable_context() {
            ...
            indexer.context_mut().add_component("test.ts", IndexedComponent {
